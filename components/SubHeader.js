...
const SubHeader = () => {
  ...
  return (
    <div>
      {!isSmallScreen && (
        <div className='w-full mt-[150px] h-[50px] md:mt-[-78px] mx-auto max-w-[700px] flex justify-left items-left bg-white bg-opacity-75 px-[30px] md:px-[10px] z-50 fixed border-r-2 border-b-4'>
